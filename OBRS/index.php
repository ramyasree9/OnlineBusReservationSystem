	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>Quick Search <br> Online Booking <br> Pay Online <br> Hassle Free Bus Booking</p>
				<ul class="actions">
					<li>
		...
		<a name="about"></a>
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>BookMyTicket</h2>
						<p> <b>BookMyTicket is India's online bus reservation system. <br>You can now choose your bus and your seat, have the tickets delivered to your mail and pay the cash online. <br>Try the BookMyTicket experience today.</b></p>
		...
		<!-- Two -->
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						<section class="feature 6u 12u$(small)">
							<img class="image fit" src="images1/bus8.jpg" alt="" />
					<!--		<h3 class="title">Voluptates, repudiandae, dolor</h3>
						...
						--></section>
						<section class="feature 6u$ 12u$(small)">
							<img class="image fit" src="images1/bus7.jpg" alt="" />
